...
//    }
    ...
    private void handleClickAnimationXml(Button btn, int animId){
        final Animation animation = AnimationUtils.loadAnimation(AnimationActivity.this, animId);
    ...
    private void startHomeActivity(ImageView imageView){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //handleClickAnimationXml(btnCombineCode, R.anim.anim_combine);
    }
}